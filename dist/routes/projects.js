...
async function createProject(name, description, creatorId) {
    try {
...
async function addMembers(userId, projectId, creatorId) {
...
async function removeUserFromProject(userId, projectId, creatorId) {
    try {
        const project = await prisma.project.findUnique({
            where: {
                id: projectId,

...
async function createTask(userId: number, projectId: number, title: string, description: string, tags: string[]) {
  ...
  async function updateTask(userId: number, taskId: number, title: string, description: string, tags: string[], status: any) {
    ...
    if (!task.project.members.some((member: { id: number }) => member.id === userId)) {
